...
describe("Form", () => {
  ...
  it("validates that the student name is not blank", () => {
    ...
    const { getByText } = render(<Form interviewers={interviewers} student="" onSave={onSave} />);
  ...
  // Replaced by "can successfully save after trying to submit an empty student name"
  // xit("calls onSave function when the name and interviewer is defined", () => {
  //   /* 1. Create the mock onSave function */
  //   const onSave = jest.fn();
  //   /* 2. Render the Form with interviewers, name and the onSave mock function passed as an onSave prop */
  //   const { getByText, queryByText } = render(
  //     <Form student="Lydia Miller-Jones" interviewer={interviewers[0].id} onSave={onSave} interviewers={interviewers} />
  //   );
  //   /* 3. Click the save button */
  //   fireEvent.click(getByText("Save"));
